...
import { Linkedin, Instagram, Github, ArrowRight, Music2 } from "lucide-react"
                    ...
                    <div className="text-left md:text-right space-y-4 md:space-y-6">
                        <div className="flex justify-start md:justify-end">
                            <Link
                                ...
                                className="group flex items-center gap-2 px-4 py-2 md:px-5 md:py-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-white text-xs md:text-sm font-medium"
                            >
                                How I Built My Portfolio <ArrowRight className="w-3 h-3 md:w-4 md:h-4 group-hover:translate-x-1 transition-transform" />
                            </Link>
                        </div>
