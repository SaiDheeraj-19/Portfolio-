            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 mb-20">
                    ...
                    <div className="text-left md:text-right space-y-4 md:space-y-6">
                        ...
                        <p className="text-base md:text-2xl font-light text-primary-foreground/60 max-w-lg leading-relaxed">Designed and built by <span className="text-primary-foreground font-medium">R. Sai Dheeraj</span> to showcase AI-powered applications, real-time systems, and scalable digital products.</p>
                    </div>
                </div>
            </div>
