  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section id="home" className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center -mt-12 animate-in fade-in duration-1000">
          ...
          <div className="origin-top animate-swing hover:animate-none transition-all duration-500 ease-out">
            <div className="w-[320px] h-[480px] md:w-[380px] md:h-[550px]">
              <ProfileCard
                name="Sai Dheeraj"
        ...
        <div className="absolute bottom-10 w-full z-20 pointer-events-none">
          <div className="absolute left-6 md:left-12 bottom-2 border border-neutral-500 rounded-full w-12 h-12 flex items-center justify-center text-neutral-300 font-mono text-sm pointer-events-auto">
            01
          </div>

          <div className="absolute left-1/2 -translate-x-1/2 bottom-0 flex flex-col items-center gap-2 animate-bounce text-neutral-300 font-mono">
            <span className="text-xs tracking-widest">SCROLL</span>
            <div className="w-[1px] h-12 bg-neutral-500" />
          </div>

          <div className="absolute right-6 md:right-12 bottom-2 text-right text-neutral-400 font-mono text-sm pointer-events-auto">
            <span className="block text-xs uppercase tracking-wider mb-1">Leveled up by:</span>
            <span className="font-bold text-white">HARDWORK</span>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 md:py-32 px-6 overflow-hidden bg-black">
        ...
        <div className="absolute right-6 md:right-12 bottom-10 z-20 pointer-events-auto">
          <Button
            variant="outline"
            className="rounded-full border-neutral-700/50 bg-black/20 text-neutral-400 backdrop-blur-sm hover:bg-white hover:text-black transition-all duration-300 px-6 py-6 font-mono text-xs tracking-widest"
      ...
      <Dialog open={showAboutPopup} onOpenChange={setShowAboutPopup}>
        <DialogContent className="max-w-[95vw] bg-black border-neutral-800 text-white p-0 overflow-hidden !rounded-[2rem] w-[95vw] h-[90vh] [&>button]:hidden">
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-start p-8 md:p-12 overflow-y-auto">
            {/* Close Button */}
            <button
          ...
          <div className="flex flex-col items-center">
            ...
            {!selectedCertCategory ? (
              ...
              <div className="w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full animate-in fade-in zoom-in-95 duration-300">
      ...
      <Dialog open={showContactPopup} onOpenChange={setShowContactPopup}>
        <DialogContent className="max-w-3xl bg-neutral-950/90 backdrop-blur-2xl border-neutral-800 text-white p-0 overflow-hidden rounded-[2.5rem] shadow-2xl [&>button]:hidden">
          ...
          <div className="p-10 md:p-14 relative z-10 flex flex-col items-center">
            ...
            <p className="text-neutral-400 mb-12 text-center text-lg max-w-lg leading-relaxed">Choose your preferred way to connect. I'm always open to discussing new projects and ideas.</p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
              {/* WhatsApp */}
              <a href="https://wa.me/919493552753" target="_blank" rel="noopener noreferrer"
                className="group relative flex flex-col items-center justify-center p-8 rounded-3xl bg-neutral-900/60 border border-white/5 hover:bg-[#25D366]/10 hover:border-[#25D366]/50 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(37,211,102,0.2)]">
                <div className="w-20 h-20 mb-6 rounded-full bg-[#25D366]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-inner">
                ...
                <span className="font-bold text-xl text-white group-hover:text-[#25D366] transition-colors">WhatsApp</span>
                <span className="text-sm text-neutral-500 mt-2 font-mono tracking-wider opacity-60 group-hover:opacity-100 transition-opacity">Chat Now</span>
              </a>

              {/* Phone */}
              <a href="tel:+919908918853"
                className="group relative flex flex-col items-center justify-center p-8 rounded-3xl bg-neutral-900/60 border border-white/5 hover:bg-blue-500/10 hover:border-blue-500/50 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                <div className="w-20 h-20 mb-6 rounded-full bg-blue-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-inner">
                  <Phone className="w-10 h-10 text-blue-500 fill-current" />
                </div>
                <span className="font-bold text-xl text-white group-hover:text-blue-500 transition-colors">Call Me</span>
                <span className="text-sm text-neutral-500 mt-2 font-mono tracking-wider opacity-60 group-hover:opacity-100 transition-opacity">Personal Line</span>
              </a>

              {/* Email */}
              <a href="mailto:16saidheeraj@gmail.com"
                className="group relative flex flex-col items-center justify-center p-8 rounded-3xl bg-neutral-900/60 border border-white/5 hover:bg-white/10 hover:border-white/50 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                <div className="w-20 h-20 mb-6 rounded-full bg-white/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-inner">
                  <Mail className="w-10 h-10 text-white fill-current" />
                </div>
                <span className="font-bold text-xl text-white group-hover:text-white transition-colors">Email</span>
                <span className="text-sm text-neutral-500 mt-2 font-mono tracking-wider opacity-60 group-hover:opacity-100 transition-opacity">Send Message</span>
              </a>
            </div>
          </div>
        </DialogContent>
