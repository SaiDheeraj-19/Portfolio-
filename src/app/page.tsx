    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative pt-16 pb-32 md:py-32 px-4 md:px-6 overflow-hidden bg-background">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          >
            I am a <span className="font-bold text-primary">Full-Stack x AI Engineer</span> with deep expertise spanning computer vision, multilingual processing, and robust real-time infrastructure.
          </motion.p>
        </div>
